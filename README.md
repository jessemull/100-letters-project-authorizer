...
The **100 Letters Project Authorizer** provides authentication for the **100 Letters Project API**.
...
This project implements an **AWS Lambda Authorizer** function for the **100 Letters Project API** to enhance the security and functionality of a static **Next.js** website hosted on **S3** and served via **CloudFront**.

### **Key Features:**

- **Cognito Authentication**: Protects the 100 letters API by verifying AWS Cognito access tokens.
- **Next.js Compatibility**: Works with static site exports to provide seamless navigation.

### **Authentication & Security**

- The function enforces authentication for the 100 letters project API gateway using **AWS Cognito** tokens.
...
- **GitHub Actions**: Automates CI/CD workflows, handling linting, testing, and deployment of lambda functions.
...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/jessemull/100-letters-project-authorizer.git
   ```
...
Authorizer deployments must have a package size under 1MB. Using webpack optimization the bundle size is less than 50KB.
